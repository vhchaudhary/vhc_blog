...
(function(b) {
    ...
    var FULL_PATH = 'http://zdev.mykuwaitnet.net'
    var a = function(d, c) {
        this.$el = b(d);
        this.opts = b.extend({
            lang: "en",
            ...
            modal_file: '<form id="redactorUploadFileForm" method="post" action="" enctype="multipart/form-data"><input type="file" id="redactor_file" name="file" /></form>',
            modal_image: '<div id="redactor_tabs"><a href="javascript:void(null);" class="redactor_tabs_act">%__.upload%</a><a href="javascript:void(null);">%__.choose%</a> <a href="javascript:void(null);">%__.link%</a> </div><form id="redactorInsertImageForm" method="post" action="" enctype="multipart/form-data"><div id="redactor_tab1" class="redactor_tab"><input type="file" id="redactor_file" name="file" /></div><div id="redactor_tab2" class="redactor_tab" style="display: none;"><div id="redactor_image_box"></div></div></form> <div id="redactor_tab3" class="redactor_tab" style="display: none;"><table class="redactor_ruler" width="100%"><tr><td nowrap>%__.image_web_link%</td><td width="100%"><input name="redactor_file_link" id="redactor_file_link"  style="width: 99%"  /></td></tr><tr><td></td><td><span class="redactor_btns_box"><input type="button" name="upload" id="redactor_upload_btn" value="%__.insert%" />&nbsp;&nbsp;<a href="javascript:void(null);" style="color: #777; font-size: 12px;" id="redactor_btn_modal_close">%__.cancel%</a></span><div style="clear: both;"></div></td></tr></table></div>',
            modal_image_edit: '<table class="redactor_ruler"><tr><td nowrap>%__.title%</td><td><input id="redactor_file_alt" style="width: 99%;" /></td></tr><tr><td nowrap>%__.link%</td><td><input id="redactor_file_link" style="width: 99%;" /></td></tr><tr><td nowrap class="small">%__.image_position%</td><td width="100%"><select id="redactor_form_image_align"><option value="none">%__.none%</option><option value="left">%__.left%</option><option value="right">%__.right%</option></select></td></tr><tr><td><a href="javascript:void(null);" id="redactor_image_delete_btn" style="color: #000;">%__._delete%</a></td><td><span class="redactor_btns_box"><input type="button" name="sav" id="redactorSaveBtn" value="%__.save%" />&nbsp;&nbsp;<a href="javascript:void(null);" style="color: #777; font-size: 12px;" id="redactor_btn_modal_close">%__.cancel%</a></span><div style="clear: both;"></div></td></tr></table>',
            modal_link: '<form id="redactorInsertLinkForm" method="post" action="" enctype="multipart/form-data"><div id="redactor_tabs"><a href="javascript:void(null);" class="redactor_tabs_act">URL</a><a href="javascript:void(null);">Email</a><a href="javascript:void(null);">%__.anchor%</a><a href="javascript:void(null);">%__.file%</a></div><input type="hidden" id="redactor_tab_selected" value="1" /><div class="redactor_tab" id="redactor_tab1"><table class="redactor_ruler"><tr><td nowrap>URL</td><td width="100%"><input id="redactor_link_url" style="width: 99%; font-size: 16px;"  /></td></tr><tr><td>%__.text%</td><td><input class="redactor_link_text" id="redactor_link_url_text" style="width: 99%; font-size: 16px;" /></td></tr></table></div><div class="redactor_tab" id="redactor_tab2" style="display: none;"><table class="redactor_ruler"><tr><td nowrap>Email</td><td width="100%"><input id="redactor_link_mailto" style="width: 99%; font-size: 16px;"  /></td></tr><tr><td>%__.text%</td><td><input class="redactor_link_text" id="redactor_link_mailto_text" style="width: 99%; font-size: 16px;" /></td></tr></table></div><div class="redactor_tab" id="redactor_tab3" style="display: none;"><table class="redactor_ruler"><tr><td nowrap>%__.anchor%</td><td width="100%"><input id="redactor_link_anchor" style="width: 99%; font-size: 16px;"  /></td></tr><tr><td>%__.text%</td><td><input class="redactor_link_text" id="redactor_link_anchor_text" style="width: 99%; font-size: 16px;" /></td></tr></table></div><div class="redactor_tab" id="redactor_tab4" style="display: none;"><table class="redactor_ruler"><tr><td>%__.text%</td><td><input class="redactor_link_text" id="redactor_link_file_text" style="width: 99%; font-size: 16px;" /></td></tr><tr><td></td><td><input type="file" id="redactor_file" name="file" /></td></tr></table></div></form><span class="redactor_btns_box"><input type="button" id="redactor_insert_link_btn" value="%__.insert%" />&nbsp;&nbsp;<a href="javascript:void(null);" style="color: #777; font-size: 12px;" id="redactor_btn_modal_close">%__.cancel%</a></span><div style="clear: both;"></div>',
            modal_table: '<table class="redactor_ruler" width="99%"><tr><td>%__.Rows%:</td><td width="100%"><input size="5" value="2" id="redactor_table_rows" /></td></tr><tr><td>%__.Columns%:</td><td><input size="5" value="3" id="redactor_table_columns" /></td></tr><tr><td></td><td><br /><span class="redactor_btns_box"><input type="button" name="upload" id="redactor_insert_table_btn" value="%__.insert%" />&nbsp;&nbsp;<a href="javascript:void(null);" style="color: #777; font-size: 12px;" id="redactor_btn_modal_close">%__.cancel%</a></span><div style="clear: both;"></div></td></tr></table>',
            modal_video: '<form id="redactorInsertVideoForm"><div style="font-size: 11px; margin-bottom: 3px;">%__.video_html_code%</div><table class="redactor_ruler" style="width: 99%;"><tr><textarea id="redactor_insert_video_area" style="width: 99%; height: 160px;"></textarea></tr></table></form><span class="redactor_btns_box"><input type="button" id="redactor_insert_video_btn" value="%__.insert%" />&nbsp;&nbsp;<a href="javascript:void(null);" style="color: #777; font-size: 12px;" id="redactor_btn_modal_close">%__.cancel%</a></span><div style="clear: both;"></div>'
        }, c, this.$el.data());
        this.dropdowns = [];
        this.init()
    };
    a.prototype = {
        _loadFile: function(c, f) {
            var d = f[0];
            f.splice(0, 1);
            var e;
        ...
        init: function() {
            ...
            if (this.opts.load) {
                ...
                if (this.opts.extra_script !== false) {
                    c.push(this.opts.path + "/" + this.opts.extra_script)
                }
            ...
            if (this.opts.cleanUp === true) {
                b(this.doc).bind("paste", b.proxy(function(d) {
                    setTimeout(b.proxy(function() {
                        var e = Math.floor(Math.random() * 99999);
                        var g = "";
                        if (b.browser.mozilla) {
                            g = "&nbsp;"
                        }
                        var f = b('<span rel="pastemarkerend" id="pastemarkerend_' + e + '">' + g + "</span>");
                        this.insertNodeAtCaret(f.get(0));
                        this.pasteCleanUp(e)
                    }, this), 100)
                }, this))
            }
        ...
        pasteCleanUp: function(c) {
            var d = this.$editor.html();
            d = this.formating(d);
            d = this.cleanUp(d);
            if (this.opts.removeClasses) {
                d = d.replace(/ class="([\w\W]*?)"/gi, "")
            } else {
                d = this.cleanUpClasses(d)
            }
            if (this.opts.removeStyles) {
                d = d.replace(/ style="([\w\W]*?)"/gi, "")
            } else {
                d = this.cleanUpStyles(d)
            }
            d = this.cleanUp(d);
            d = this.formating(d);
            d = d.replace(/<b(.*?)id="internal-source-marker(.*?)">([\w\W]*?)<\/b>/gi, "$3");
            this.$editor.html(d);
            var e = b(this.doc.body).find("#pastemarkerend_" + c).get(0);
            this.setFocusNode(e);
            b(e).remove();
            this.syncCode();
            this.observeImages()
        ...
        buildDropdown: function(d, c) {
            b.each(c, b.proxy(function(e, g) {
                ...
                if (g.name == "separator") {
                    ...
                    f = b('<a href="javascript:void(null);" style="' + g.style + '">' + g.title + "</a>").addClass("dropdown_item_" + e);
        ...
        showTable: function() {
            this.modalInit(RLANG.table, "table", 344, b.proxy(function() {
        ...
        showVideo: function() {
            ...
            this.modalInit(RLANG.video, "video", 600, b.proxy(function() {
        ...
        imageEdit: function(g) {
            ...
            this.modalInit(RLANG.image, "image_edit", 380, d)
        },
        ...
        showImage: function() {
            ...
            this.modalInit(RLANG.image, "image", 570, c, true)
        },
        ...
        showLink: function() {
                ...
                if (this.opts.linkFileUpload === false) {
                    ...
                    if (b("#redactor_file").size() != 0) {
                        b("#redactor_file").dragupload({
                            ...
                            success: b.proxy(this.insertLinkFile, this)
                        })
                    }
                    this.uploadInit("redactor_file", {
                        auto: true,
            ...
            this.modalInit(RLANG.link, "link", 460, c)
        },
        insertLink: function() {
        ...
        showFile: function() {
            ...
            this.modalInit(RLANG.file, "file", 500, c)
        },
        ...
        modalInit: function(h, e, g, f, d) {
            ...
            this.hdlModalClose = b.proxy(function(i) {
                if (i.keyCode == 27) {
                    this.modalClose()
                }
            }, this);
            ...
            data = this.opts["modal_" + e];
            b.each(RLANG, function(j, l) {
                var k = new RegExp("%__." + j + "%", "gi");
                data = data.replace(k, l)
            });
            b("#redactor_modal_inner").html(data);
            b("#redactor_modal_header").html(h);
            ...
            var c = b("#redactor_modal").outerHeight();
            b("#redactor_modal").css({
                width: g + "px",
                height: "auto",
                marginTop: "-" + (c + 10) / 2 + "px",
                marginLeft: "-" + (g + 60) / 2 + "px"
            }).fadeIn("fast");
            if (d === true) {
    ...
    b.fn.getSelection = function() {
        return this.data("redactor").getSelection()
    };
    b.fn.getSettings = function() {
